...
export const Route = createFileRoute('/motivation')({
  ...
  head: () => ({
    meta: openGraphMeta({
      ...sitePages.motivation,
      image: getSiteOgImageUrl('motivation'),
    }),
  }),
})
...
function MotivationPage() {
  return (
    <HomeLayout {...baseOptions()}>
      <PageHero
        eyebrow="Motivation"
        title={<>Why <SectionAccent>Taser</SectionAccent> exists</>}
        ...
        actions={(
          <>
            ...
            <Link to="/sponsor" className={secondaryButtonClass}>
              Sponsor the project
            </Link>
          </>
        )}
      ...
      <PageSection
        muted
        title={<>Inspired by <SectionAccent>TanStack Router</SectionAccent></>}
      ...
      <PageSection
        muted
        title={<>The idea: make composition <SectionAccent>type safe</SectionAccent></>}
