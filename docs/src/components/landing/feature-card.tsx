...
export const iconTones = {
  ...
  sky: "[&>div:first-child]:border-sky-500/20 [&>div:first-child]:bg-sky-500/10 [&>div:first-child]:text-sky-600 dark:[&>div:first-child]:text-sky-400",
  emerald:
  ...
  rose: "[&>div:first-child]:border-rose-500/20 [&>div:first-child]:bg-rose-500/10 [&>div:first-child]:text-rose-600 dark:[&>div:first-child]:text-rose-400",
  cyan: "[&>div:first-child]:border-cyan-500/20 [&>div:first-child]:bg-cyan-500/10 [&>div:first-child]:text-cyan-600 dark:[&>div:first-child]:text-cyan-400",
  orange:
