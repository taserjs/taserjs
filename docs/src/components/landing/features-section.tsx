...
const features: { icon: ReactNode; title: string; description: string; iconTone: IconTone }[] = [
  ...
  },
  {
    ...
    description:
      "Validate with any standard schema libraries of your choice like Zod, Arktype, Valibot, etc.",
    iconTone: "indigo",
  },
  {
    icon: <Sparkles />,
    ...
    <section className="relative bg-fd-muted/25">
      ...
      <div className="mx-auto max-w-(--fd-layout-width) px-6 py-16 md:py-24">
        <SectionHeader
          ...
          title={
            <>
              Built for teams who hate <SectionAccent>repeating type assertions</SectionAccent>
            </>
          }
