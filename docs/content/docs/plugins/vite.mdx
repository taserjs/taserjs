---
title: Vite Plugin
description: "Integrate Taser with Vite using @taserjs/router-plugin/vite. Virtual route resolution, ambient type generation, instant HMR, and standalone builds."
icon: Zap
---
...
<Cards>
  <Card
    ...
    description="Integrate Taser with TanStack Start fullstack applications and React Query."
  />
  <Card
