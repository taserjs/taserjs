...
description: "Deploy Taser.js APIs across Cloudflare Workers, Vercel, AWS Lambda, Node.js, Bun, Deno, and Netlify using multi-cloud Nitro server presets."
icon: Globe
---
...
Taser.js leverages Nitro's battle-tested preset system to generate optimized production builds tailored for any cloud platform or runtime with zero code changes.
...
<Cards>
  <Card
    ...
    description="Learn how Taser.js integrates with Nitro's compiler and lifecycle hooks."
  />
  <Card
    title="Vite Plugin"
