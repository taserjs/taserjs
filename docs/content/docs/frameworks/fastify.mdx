...
description: "Pair Taser file routing with Fastify. Coexist with Fastify plugins, hooks, and native route handlers using host pass-through architecture."
icon: Workflow
---
...
<Cards>
  ...
  <Card
    ...
    description="Deploy Fastify + Taser to Node server or containerized clusters."
  />
</Cards>
