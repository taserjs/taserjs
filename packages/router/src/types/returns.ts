...
export type MergeReturns<
  A extends ReturnsMap,
  B extends ReturnsMap,
> = Omit<A, keyof B> & B
 ...
 */
export type ValidHandlerReply<R, M extends ReturnsMap> = R extends ReplyOf<infer S, infer B>
  ? S extends keyof M
    ? M[S] extends Schema<unknown>
 ...
 */
export type EnforceHandlerReply<R, M extends ReturnsMap>
  = [R] extends [ValidHandlerReply<R, M>]
    ? R
