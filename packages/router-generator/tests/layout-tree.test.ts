...
import { layoutAppliesToRoute, layoutParentId, routeLayoutChain } from '../src/model/layout-tree.js'
...
describe('routeLayoutChain', () => {
  ...
  it('includes root splat as outermost layout', () => {
    expect(routeLayoutChain('account/overview', layoutsWithRoot)).toEqual(['/$', 'account', 'account/$'])
  })
})
