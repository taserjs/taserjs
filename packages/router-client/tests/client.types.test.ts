...
import type { Client, InferRequestType, InferResponseType, OpenQuery, QueryWithOpen } from '../src/types.js'
import { formBody, type FormBody, type FormBodyField, type FormBodyInput } from '../src/form-body.js'
      ...
      POST: {
        ...
        route: {
          ...
          $Infer: {
            ...
            Output: ReplyOf<200, { query: { page: number, name: string }, body: { name: string, file: File } }>
          }
